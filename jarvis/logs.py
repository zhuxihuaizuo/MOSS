# -*- coding: utf-8 -*-
# @Time    : 2023/4/16 下午8:19
# @Author  : Su Yang
# @File    : logs.py
# @Software: PyCharm 
# @Comment : Logging module for Auto-GPT.
...
from jarvis.speech import say_text
from jarvis.singleton import Singleton
...
class Logger(metaclass=Singleton):
    ...
    def typewriter_log(
        ...
        if speak_text and settings.SPEECH_MODE:
